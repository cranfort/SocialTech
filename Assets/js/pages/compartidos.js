    ...
    http.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            <h5 class="mailbox-open-title">
                Nombre del Archivo Compartido: ${res.nombre}
            </h5>
                ...
                <div class="mailbox-open-content-email-attachments">
                    <ul class="attachments-files-list list-unstyled">
                        <li class="attachments-files-list-item">
                            ...
                            <a href="${base_url + 'Assets/archivos/' + res.id_carpeta + '/' + res.nombre}" download="${base_url + 'Assets/archivos/' + res.id_carpeta + '/' + res.nombre}" class="attachments-files-list-item-download-btn">
...
function eliminarCompartido(id) {
    ...
    eliminarRegistro('¿ESTA SEGURO DE ELIMINAR?', 'EL ARCHIVO COMPARTIDO SE ELIMINARÁ DE FORMA PERMANENTE EN 30 DÍAS', 'SI ELIMINAR', url, null);
