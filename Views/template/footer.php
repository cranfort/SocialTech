                     ...
                     <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-1 mb-50">
                           <div class="tp-footer-widget-content">
                              ...
                              <p class="tp-footer-desc">Somos un equipo de diseñadores y desarrolladores que creamos sitios de alta calidad</p>
                              ...
                              <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="mailto:shofy@support.com">socialtech@support.com</a></p>
                                    </div>
                                 </div>
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
                     ...
                     <div class="row align-items-center">
                        <div class="col-md-6">
                           <div class="tp-footer-copyright">
                              <p>© 2024 Todos los derechos reservados  |  Diseñado por <a href="index.html">SocialTech</a>.</p>
                           </div>
                        </div>
                        <div class="col-md-6">
