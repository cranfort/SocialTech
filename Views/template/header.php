...
<html class="no-js" lang="zxx">
   <head>
      ...
      <title>SocialTech - Multipurpose eCommerce</title>
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1">

      <!-- Place favicon.ico in the root directory -->
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo BASE_URL . 'Assets/img/logo/socia2.png'; ?>">
      ...
      <link rel="stylesheet" href="<?php echo BASE_URL . 'Assets/css/font-awesome-pro.css'; ?>">
      <link rel="stylesheet" href="<?php echo BASE_URL . 'Assets/css/flaticon_shofy.css'; ?>">
            ...
            <div id="loading-center-absolute">
               ...
               <div class="tp-preloader-content">
                  <div class="tp-preloader-logo">
                     ...
                     <img src="<?php echo BASE_URL . 'Assets/img/logo/socia2.png'; ?>" alt="" width="185px">
                  </div>
                  <h3 class="tp-preloader-title">Social Tech</h3>
            ...
            <div class="offcanvas__content">
               <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                  <div class="offcanvas__logo logo">
                     <a href="#">
                        <img src="<?php echo BASE_URL . 'Assets/img/logo/socia2.png'; ?>" alt="logo" width="20px">
                     </a>
                  </div>
               </div>
               ...
               <div class="offcanvas__contact align-items-center d-none">
                  <div class="offcanvas__contact-icon mr-20">
                     <span>
                        <img src="<?php echo BASE_URL . 'Assets/img/icon/contact.png'; ?>" alt="">
                     </span>
                  </div>
                  ...
                  <div class="offcanvas__select language">
                     <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                        <div class="offcanvas__lang-img mr-15">
                           <img src="<?php echo BASE_URL . 'Assets/img/icon/language-flag.png'; ?>" alt="">
                        </div>
         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             <div class="cartmini__top-wrapper">
                     ...
                     <div class="cartmini__widget-item">
                         <div class="cartmini__thumb">
                           <a href="product-details.html">
                              <img src="<?php echo BASE_URL . 'Assets/img/product/product-1.jpg'; ?>" alt="">
                           </a>
                         </div>
                 ...
                 <div class="cartmini__empty text-center d-none">
                     <img src="<?php echo BASE_URL . 'Assets/img/product/cartmini/empty-cart.png'; ?>" alt="">
                  ...
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="tp-header-welcome d-flex align-items-center">
                           ...
                           <p>Con entregas rápidas y seguras dentro de tu zona local</p>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="tp-header-top-right d-flex align-items-center justify-content-end">
                           <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                              <div class="tp-header-top-menu-item tp-header-lang">
                                 <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">Español</span>
                                 <ul>
                                    <li>
                                       <a href="#">Ingles</a>
                                    </li>
                              ...
                              <div class="tp-header-top-menu-item tp-header-currency">
                                 <span class="tp-header-currency-toggle" id="tp-header-currency-toggle">COL</span>
                                 <ul>
                                    <li>
                                       <a href="#">USD</a>
                                    </li>
                              ...
                              <div class="tp-header-top-menu-item tp-header-setting">
                                 <span class="tp-header-setting-toggle" id="tp-header-setting-toggle">Ajustes</span>
                                 <ul>
                                    <li>
                     ...
                     <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                        <div class="logo">
                           <a href="<?php echo BASE_URL . 'principal'; ?>">
                              <img src="<?php echo BASE_URL . 'Assets/img/logo/socia2.png'; ?>" alt="logo" width="100px">
                           </a>
                        </div>
                     </div>
                     ...
                     <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                           <div class="tp-header-login d-none d-lg-block">
                              <a href="<?php echo BASE_URL . 'perfil'; ?>" class="d-flex align-items-center">
                                 ...
                                 <div class="tp-header-login-content d-none d-xl-block">
                                    ...
                                    <h5 class="tp-header-login-title">Su cuenta</h5>
                                 </div>
                              </a>
                           </div>
                           <div class="tp-header-action d-flex align-items-center ml-50">
                              <div class="tp-header-action-item d-none d-lg-block">
                                 <a href="<?php echo BASE_URL . 'productos/comparar'; ?>"  class="tp-header-action-btn">
                              ...
                              <div class="tp-header-action-item d-none d-lg-block">
                                 <a href="<?php echo BASE_URL . 'productos/wishlist'; ?>" class="tp-header-action-btn">
                                      ...
                                      <a href="shop.html" class="has-mega-menu">
                                         ...
                                         <ul class="mega-menu tp-submenu">
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                     <a href="shop.html"><img src="<?php echo BASE_URL . 'Assets/img/header/menu/menu-1.jpg'; ?>" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="<?php echo BASE_URL . 'Assets/img/header/menu/menu-2.jpg'; ?>" alt=""></a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                               ...
                                               <ul>
                                                  <li>
                                                   <a href="shop.html"><img src="<?php echo BASE_URL . 'Assets/img/header/menu/menu-3.jpg'; ?>" alt=""></a>
                                                  </li>
                                                  <li>
